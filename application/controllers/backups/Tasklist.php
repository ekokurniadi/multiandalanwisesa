...
class Tasklist extends MY_Controller {
    ...
    public function fetch_data(){
        ...
        if($_SESSION['level']=="Admin"){
            ...
            $where ="WHERE a.task_status in('Process','OTW','Belum') AND b.area_name='{$_SESSION['b.area_name']}'";
        }
        if($_SESSION['level']=="Admin"){
            ...
            $where2 ="WHERE a.task_status in('Process','OTW','Belum') AND b.area_name='{$_SESSION['b.area_name']}'";
        }
        $searchingColumn;
        $result=array();
        if (isset($search)) {
        ...
        if (isset($orders)) {
            if ($orders != '') {
              $order = $orders;
              $order_column = ['a.task_id','a.date','a.customer_id','b.device_id','b.customer_name','b.address','a.indikasi','a.klasifikasi','a.task_status'];
