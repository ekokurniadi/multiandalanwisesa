  ...
  <div class="row">
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <form class="form-horizontal">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="varchar">Harga Satuan <?php echo form_error('harga_satuan') ?></label>
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="harga_satuan" id="harga_satuan" placeholder="Harga Satuan" value="<?php echo $harga_satuan; ?>" readonly />
                </div>
              </div>
	    ...
	    <a href="<?php echo site_url('produk') ?>" class="btn btn-icon icon-left btn-success">Cancel</a>
