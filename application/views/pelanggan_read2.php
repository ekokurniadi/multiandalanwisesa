  ...
  <div class="row">
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <form class="form-horizontal">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <div class="col-sm-12">
                    <textarea class="form-control" rows="6" name="alamat" id="alamat" placeholder="Alamat"><?php echo $alamat; ?></textarea>
                </div>
              </div>
	    ...
	    <a href="<?php echo site_url('pelanggan/index_mobile') ?>" class="btn btn-icon icon-left btn-success">Cancel</a>
