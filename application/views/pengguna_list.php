    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="#"> Pengguna </a></div>
                     ...
                     <form action="<?php echo site_url('pengguna/index'); ?>" class="form-inline" method="get">
                          ...
                          <span class="input-group-btn">
                              <?php 
                                  ...
                                  {
                                      ?>
                                      <a href="<?php echo site_url('pengguna'); ?>" class="btn btn-warning"><span class="fa fa-close"> </span> Reset</a>
                                      <?php
                                  }
                              ?>
		...
		<th>Action</th>
			...
			<td><?php echo $pengguna->user_id ?></td>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('pengguna/read/'.$pengguna->id),'<i class="fa fa-eye"></i>',array('title'=>'detail','class'=>'btn btn-icon icon-left btn-light')); 
				echo '  '; 
				echo anchor(site_url('pengguna/update/'.$pengguna->id),'<i class="fa fa-pencil-square-o"></i>',array('title'=>'edit','class'=>'btn btn-icon icon-left btn-warning')); 
				echo '  '; 
				echo anchor(site_url('pengguna/delete/'.$pengguna->id),'<i class="fa fa-trash-o"></i>','title="delete" class="btn btn-icon icon-left btn-danger" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr></tbody>
                          <?php
